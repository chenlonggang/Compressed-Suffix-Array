...
extern void deep_sort(UInt32 *a, Int32 n, Int32 depth);
...
{ 
  ...
  if(best_forw_anchor>=0 && min_forw_offset<depth-1) {
    ...
    assert(Sa[anchor_rank]== (UInt32) anchor_pos);
  ...
  if(best_back_anchor>=0) {
    ...
    for(i=0;i<n;i++) {
      if(((Int32) a[i]+max_back_offset)<0) 
...
/* *******************************************************************
   ...
   ******************************************************************** */
static void pseudo_anchor_sort(UInt32 *a, Int32 n,Int32 pseudo_an,Int32 offset);
static void pseudo_or_deep_sort(UInt32 *a, Int32 n, Int32 depth)
{
...
/* ********************************************************************
   ...
   ******************************************************************** */
static void general_anchor_sort(UInt32 *a, Int32 n, 
...
static void update_anchors(UInt32 *a, Int32 n)
{
  ...
  for(i=0;i<n;i++) {
    ...
    if(toffset<aoffset) {
      ...
      assert(Sa[Anchor_rank[anchor]]== (UInt32)
